...
export default async function OrdersPage() {
  ...
  return (
    <>
      <SeoHead
        title="My Orders"
        description="View your NovaTech order history."
      />
      <AccountLayout
            ...
            <div className="flex flex-col items-center justify-center py-32 border border-white/5 bg-card/20 backdrop-blur-md rounded-2xl gap-6 text-center shadow-inner relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm max-w-xs mb-8 leading-relaxed">
                  You haven&apos;t placed any orders yet. Start shopping our
                  premium catalog.
                </p>
                <Link
                  href="/products"
                  className={buttonVariants({
                    ...
                    size: "lg",
                    className:
                      "gap-2 rounded-full px-8 shadow-glow-sm hover:shadow-glow transition-all",
                  })}
                >
                    ...
                    <div className="px-6 py-5 border-b border-border/20 flex flex-col sm:flex-row justify-between gap-4 sm:items-center bg-white/[0.02]">
                      <div className="flex items-center gap-6">
                        <div>
                          ...
                          <p className="font-mono text-xs text-foreground/80 font-medium group-hover:text-primary transition-colors">
                            {order.id.slice(0, 16)}…
                          </p>
                        </div>
                        ...
                        {order.items.map((item) => (
                          ...
                          >
                            <div className="flex items-center gap-4">
                              <span className="text-[10px] font-mono w-6 h-6 flex items-center justify-center text-primary bg-primary/10 border border-primary/20 rounded-full">
                                {item.quantity}×
                              </span>
